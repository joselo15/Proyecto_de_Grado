...
class Departamentos extends CI_Controller {
	...
	{
		$listadepartamentos=$this->departamento_model->listardepartamentos();
		$data['departamento']=$listadepartamentos;
		$this->load->view('inc/head');
		$this->load->view('departamentos/listadepartamentos_view',$data);
