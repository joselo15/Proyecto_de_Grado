...
<!-- Bootstrap 3.3.6 -->
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE/bootstrap/css/fonts.css">
  <!-- Font Awesome -->
    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset" style="padding: 10px 0; color:#fff;">
                <figure>
                    <img src="<?php echo base_url(); ?>assets/img/logoEdisoftModificado2.png" alt="" class="img-responsive center-box" style="width:55%;">
                </figure>
            ...
            <div class="full-reset nav-lateral-list-menu" >
                <ul class="list-unstyled">
                   <li><a href="<?php echo base_url(); ?>index.php/copropietarios/index1"><i class="zmdi zmdi-home zmdi-hc-fw "></i>&nbsp;&nbsp; INICIO</a></li>
                    <li>
                        <div class="dropdown-menu-button"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i>&nbsp;&nbsp; COPROPIETARIOS Y DEPARTAMENTOS<i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw icon-sub-menu"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="<?php echo base_url(); ?>index.php/copropietarios/listar"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp;Copropietarios</a></li>
                            <li><a href="<?php echo base_url(); ?>index.php/departamentos/index"><i class="zmdi zmdi-store zmdi-hc-fw"></i>&nbsp;&nbsp;Departamentos</a></li>
                     ...
                     <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="<?php echo base_url(); ?>index.php/usuarios/listar"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i>&nbsp;&nbsp;Usuarios</a></li>
                        </ul>
                    </li>
                    <li>
                        <div class="dropdown-menu-button"><i class="zmdi zmdi-money zmdi-hc-fw"></i>&nbsp;&nbsp; INGRESOS - EGRESOS <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw icon-sub-menu"></i></div>
                        <ul class="list-unstyled">
                             <li><a href="<?php echo base_url(); ?>index.php/expendios/index"><i class="zmdi zmdi-money bag euro zmdi-hc-fw"></i>&nbsp;&nbsp; Expensas</a></li>
                            <li>
                                <a href=""><i class="zmdi zmdi-card zmdi-hc-fw"></i>&nbsp;&nbsp; Gastos Comunes</a>
                            </li>
                            <li>
                                <a href=""><i class="zmdi zmdi-card zmdi-hc-fw"></i>&nbsp;&nbsp; Reservaciones <span class="label label-danger pull-right label-mhover">4</span></a>
                            </li>
                        </ul>
                    </li>
                    <li><a href=""><i class="zmdi zmdi-trending-up zmdi-hc-fw"></i>&nbsp;&nbsp; REPORTES Y ESTADÍSTICAS</a></li>
                     <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href=""><i class="zmdi zmdi-bookmark-outline zmdi-hc-fw"></i>&nbsp;&nbsp; Cuenta General</a></li>
                            <li><a href=""><i class="zmdi zmdi-assignment-account zmdi-hc-fw"></i>&nbsp;&nbsp; Cuenta Caja Chica</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">   
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <figure>
                   <img  src="<?php echo base_url(); ?>assets/img/user04.png" alt="user-picture" class="img-responsive img-circle center-box">
                </figure>
               ...
               <!--  <li  class="tooltips-general search-book-button" data-href="" data-placement="bottom" title="Buscar ">
                ...
                <!-- <a href="#"><i class="fas fa-user-cog"> ::before</i></a>
                <li  class="tooltips-general btn-help" data-placement="bottom" title="Ayuda">
                    <i class="zmdi zmdi-help-outline zmdi-hc-fw"></i>
                </li>  logo para confurar usuario -->
